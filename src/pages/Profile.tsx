            ...
            <div className="container py-6">
              ...
              <div className="grid gap-6 md:grid-cols-4">
                <div className="md:col-span-1 space-y-6">
                  <FacultyCard personalInfo={facultyBioData.personalInfo} />
                      ...
                      <Card>
                        ...
                        <CardContent className="grid gap-6 sm:grid-cols-2">
                          <div className="space-y-2">
                            ...
                            <Input value={facultyBioData.personalInfo.name} readOnly />
                          </div>
                          <div className="space-y-2">
                            <Label>Employee ID</Label>
                            <Input value={facultyBioData.personalInfo.employeeId} readOnly />
                          </div>
                          <div className="space-y-2">
                            <Label>Department</Label>
                            <Input value={facultyBioData.personalInfo.department} readOnly />
                          </div>
                          <div className="space-y-2">
                            <Label>Designation</Label>
                            <Input value={facultyBioData.personalInfo.designation} readOnly />
                          </div>
                          <div className="space-y-2">
                            <Label>Email</Label>
                            <Input value={facultyBioData.personalInfo.email} readOnly />
                          </div>
                          <div className="space-y-2">
                            <Label>Phone</Label>
                            <Input value={facultyBioData.personalInfo.phone} readOnly />
                          </div>
                          <div className="space-y-2">
                            <Label>Office Location</Label>
                            <Input value={facultyBioData.personalInfo.officeLocation} readOnly />
                          </div>
                          <div className="space-y-2">
                            <Label>Joining Date</Label>
                            <Input value={facultyBioData.personalInfo.joiningDate} readOnly />
                          </div>
                        </CardContent>
                      </Card>
                    </TabsContent>
